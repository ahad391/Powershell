...
Remove-Item -Path "D:\Abdul*" -Force -Verbose -ErrorAction SilentlyContinue

$outputr2c= "D:" + "\" +"\" +"Abdul" + "\" + "prod-stage" +"$DateTime" + ".xlsx" 
$outputr2cehtml= "C:" + "\" +"\" +"Abdul" + "\" +"prod-stage-report.html"
